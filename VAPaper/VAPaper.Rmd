...
This application and charts, focused on the GPS movements of the vehicle. This provides the investigator with the time and location dimension, however, there will be the question unanswered,'What were they doing there?'. This question was addressed in the first challenge. Submission from the University of Buenos Aires documented suspicious emails by combining the use of a visual network plot and a data table. Like with most submissions, they were static and only highlighted emails that they deemed as suspicious with the search by employee.  The merging of a visual and table representation of the data would be built on in our application so that the investigator can not only search by person, but also by key words (or both) that his analysis has deemed suspicious. 
